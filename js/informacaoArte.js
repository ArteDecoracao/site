var texto = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea explicabo in, quisquam, recusandae laboriosam, repudiandae tempore laborum quaerat dicta minus harum ab consequatur mollitia autem iusto nesciunt molestias quasi totam?'
...
function atualizarProduto() {
    ...
    <div class="descricao">
        <h1 class="nomeProduto">${arrayProduto[localStorage.meuProdutoEscolhido-1].nome}</h1>
        <br />
